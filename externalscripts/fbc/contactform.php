    ...
    <head>
      ...
      <script>
          ...
          <body>
            ...
            <div class="row modal2-top">
              <div class="modal-close"><i id="modal-close" class="material-icons right">close</i></div>

              <div class="col s12 m7 modal2-left">
               <h4>Curious about the process of selling your business?</h4>
                <p>Download our <b>FREE</b> guide</p>
            ...
            <div class="row">
              <form id="contactForm" class="col s12" action="http://tlchatt.com/externalscripts/fbc/contactformsubmit.php" method="POST" >
                ...
                <div class="col s12 l6">
                  ...
                  <button class="btn waves-effect waves-light right" type="submit" name="action">Get your Guide
