...
<div class="row">
<div class="col s12">
<div class="caption-wrapper2 left-align">
        <h1 class="shadow light heading">Online Advertising Management Services</h1>
        <h5 class="light text-lighten-3 shadow">Affordable and effective paid distribution of your content on the right platforms for your customer base</h5>
      </div>

      <div class="logo-wrapper2">
        <img src="./img/technologic_square_black_logo.png">
      </div>
</div>
<div class="col s4 offset-s4">
<div class="imageFlash">
<img id="1" src="./img/Facebook_icon_2013.png">
<img id="2" style="display:none;" src="./img/1000px-Facebook_New_Logo_(2015).png">
